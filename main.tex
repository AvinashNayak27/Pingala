...
\begin{document}
	...
	%
	\author{ Malothu Avinash %<-this  stops a space
	}
 % <-this % stops a space
...
\begin{lstlisting}
wget https://github.com/AvinashNayak27/Pingala/tree/main/pingala/codes/1.py
\end{lstlisting}
\begin{figure}[h]
	\centering
...
Run the below python code 
\begin{lstlisting}
wget https://github.com/AvinashNayak27/Pingala/tree/main/pingala/codes/2.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/AvinashNayak27/Pingala/tree/main/pingala/codes/xnyn.py
\end{lstlisting}
\end{enumerate}
\end{document}